...
> = {
  ADMIN_OFFICE: {
    om: 'Waajjira Bulchiinsa Godinaa',
    am: 'የዞን አስተዳደር ጽ/ቤት',
    en: 'Zone Administration Office',
  },
  PROJECTS: {
    om: 'Pirojektoota',
    am: 'ፕሮጀክቶች',
  ...
  PUBLIC_EVENTS: {
    om: 'Sagantaalee Ummataa',
    am: 'የህዝብ ዝግጅቶች',
    en: 'Public Events',
  },
  INFRASTRUCTURE: {
    om: 'Misooma Bu\'uuraalee Misoomaa',
    am: 'የመሠረተ ልማት ግንባታ',
    en: 'Development Infrastructure',
  },
  PUBLIC_PARTICIPATION: {
    om: 'Hirmaannaa fi Mari\'achiisa Ummataa',
    am: 'የህዝብ ተሳትፎና ምክክር',
    en: 'Public Participation & Consultation',
  },
};
...
export default function GalleryPage() {
  ...
  const { photos, totalPages, loading } = useGallery(page);
